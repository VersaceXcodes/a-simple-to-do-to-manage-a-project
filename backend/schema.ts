...
export const createUserInputSchema = z.object({
  email: z.string().email({ message: "Invalid email address" }),
  password_hash: z.string().min(8, { message: "Password must be at least 8 characters long" }),
...
export const updateUserInputSchema = z.object({
  ...
  password_hash: z.string().min(8, { message: "Password must be at least 8 characters long" }).optional(),
